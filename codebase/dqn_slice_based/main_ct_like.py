"""
DQN Slice-Based Training for CT-Like Dataset (Full Volumes)

Simplified version of main.py for training on full 128x128x128 volumes
without subvolume splitting/reconstruction.
